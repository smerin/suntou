...
const About = () => {
  return (
    <section className={styles.about}>
      <h2>Kora player, multi instrumentalist, producer, composer.</h2>
      <p>
      ...
      <h3>Collaborations to date include</h3>
      <p>
      ...
      <p>
        ...
        O2 and the Royal Albert Hall in 2018. An impressive moment for any young
        musician and a seal of approval from the legendary artist.
      </p>
      <p>
        Here in the UK he also performs classical Kora as a solo artist at
        sizable theatres with orchestral productions and across the festival
        circuit including WOMAD, Shambala, Wilderness Festival, Hay Festival,
        Beyond the Border and more.
      </p>
      <p>
        In The Gambia, Suntou has a huge fan base and has released successful
        singles and videos. These continue to receive daily exposure on national
        TV and radio.
      </p>
      <p>
        He also runs fun and engaging drumming and Kora workshops in schools,
        colleges and universities to pass this knowledge on to the next
        generation including Project African Experience for Black History Month.
      </p>
    </section>
  );
};
